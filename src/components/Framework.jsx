...
export default function Framework() {
  return (
    <section id="framework" className="bg-slate-900 py-24">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {framework.map((item) => {
            ...
            return (
              <div
                key={item.step}
                className="relative rounded-3xl border border-white/10 bg-white/5 p-8 transition hover:border-cyan-400/40 hover:bg-white/10"
              >
                <span className="text-5xl font-bold text-white/10">
                  {item.step}
                </span>

                <div className="mt-6 flex h-12 w-12 items-center justify-center rounded-xl bg-cyan-500/10">
